...
public final class Functions
{
    ...
    public static final String WTR_KEY = "waterfall";
    public static final int WTR_NUM_PROPERTIES = 4;
    public static final int WTR_ID = 1;
    public static final int WTR_COL = 2;
    public static final int WTR_ROW = 3;
    ...
    public static final int CAT_NUM_PROPERTIES = 6;
    ...
    public static final int CAT_ACTION_PERIOD = 5;

    public static final String RAT_KEY = "rat";
    public static final int RAT_NUM_PROPERTIES = 6;
    public static final int RAT_ID = 1;
    public static final int RAT_COL = 2;
    public static final int RAT_ROW = 3;
    public static final int RAT_ANIMATION_PERIOD = 4;
    public static final int RAT_ACTION_PERIOD = 5;
...
//    }
    ...
    // keep, parameters not inherent to any class
...
//    }
    ...
    public static boolean parseWaterfall(
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == WTR_NUM_PROPERTIES) {
            Point pt = new Point(Integer.parseInt(properties[WTR_COL]),
                    Integer.parseInt(properties[WTR_ROW]));
            String id = properties[WTR_ID];
            world.setBackground(pt, new Background(id, imageStore.getImageList(id)));
        }
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == SAPLING_NUM_PROPERTIES) {
            ...
            Entity entity = new Sapling(id, pt, imageStore.getImageList(SAPLING_KEY), 0, 0,
    ...
    public static boolean parseCat(
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == CAT_NUM_PROPERTIES) {
            Point pt = new Point(Integer.parseInt(properties[CAT_COL]),
                    Integer.parseInt(properties[CAT_ROW]));
            Entity entity = createFairy(properties[CAT_ID],
                    pt,
                    Integer.parseInt(properties[CAT_ACTION_PERIOD]),
                    Integer.parseInt(properties[CAT_ANIMATION_PERIOD]),
                    imageStore.getImageList(CAT_KEY));
            world.tryAddEntity(entity);
        }
        return properties.length == CAT_NUM_PROPERTIES;
    }
...
//    }
    ...
    // kept here because p1 and p2 are different objects but they belong to the same class
...
//    }
    ...
    {
        return new Obstacle(id, position, images, 0, 0, animationPeriod);
    }
    ...
    public static Rat createRat(
            ...
            List<PImage> images)
    {
        return new Rat(id, position, images, 0, actionPeriod, animationPeriod);
    }
    ...
    public static Cat createCat(
            ...
            List<PImage> images)
    {
        return new Cat(id, position, images, 0, actionPeriod, animationPeriod);
    }
    ...
    public static DudeNotFull createDudeNotFull(
            ...
            List<PImage> images)
    {
        return new DudeNotFull(id, position, images, 0, actionPeriod, animationPeriod, resourceLimit, 0);
    }
    ...
    public static DudeFull createDudeFull(
            ...
            int resourceLimit,
            List<PImage> images) {
        return new DudeFull(id, position, images, 0, actionPeriod, animationPeriod, resourceLimit, 0);
    }
}